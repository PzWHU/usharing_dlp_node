...
typedef struct StructPerceptionGopFrame : public FrameHeader {
#else
typedef struct StructPerceptionGopFrame {
...
typedef std::shared_ptr<PerceptionGopFrame> PerceptionGopFramePtr;
