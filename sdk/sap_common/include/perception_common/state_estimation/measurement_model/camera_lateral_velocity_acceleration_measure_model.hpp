...
class CameraLateralVelocityAccelerationMeasureModel : public MeasureModelBase {
 public:
    CameraLateralVelocityAccelerationMeasureModel(
        const MeasureState& measure_state,
        const DepthTrackerParameter& depth_smooth_param);

    explicit CameraLateralVelocityAccelerationMeasureModel(
        const CameraLateralVelocityAccelerationMeasureModel&
            camera_measure_model);

    virtual ~CameraLateralVelocityAccelerationMeasureModel() = default;
