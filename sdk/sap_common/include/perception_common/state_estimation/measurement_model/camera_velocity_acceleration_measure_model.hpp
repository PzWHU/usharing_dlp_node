...
class CameraVelocityAccelerationMeasureModel : public MeasureModelBase {
 public:
    CameraVelocityAccelerationMeasureModel(
        const MeasureState& measure_state,
        const DepthTrackerParameter& depth_smooth_param);

    explicit CameraVelocityAccelerationMeasureModel(
        const CameraVelocityAccelerationMeasureModel& camera_measure_model);

    virtual ~CameraVelocityAccelerationMeasureModel() = default;
